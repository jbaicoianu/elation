...
class Facebook
{
   ...
   */
  public function getLoginUrl($params=array(), $oldmethod=true) {
  ...
  protected function setCookieFromSession($session=null) {
    ...
    // @codeCoverageIgnoreStart
      ...
      // NOTE - changed from setcookie() to setrawcookie() by james to see if it would fix the client-side interaction problems
