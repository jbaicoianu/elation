...
class ComponentManager extends Component {
  ...
  function Dispatch($page=NULL, $args=NULL, $output="html", $legacy=true) {
    ...
    $outputtype = any($args["_output"], ($legacy && !empty($_SERVER["HTTP_X_AJAX"]) ? "ajax" : $output), "html");
...
class ComponentResponse implements ArrayAccess {
  ...
  public static $outputtypes = array(
      'ajax'  => 'application/xml',
      'xml'   => 'application/xml',
      'json'  => 'application/javascript',
      'jsonp' => 'application/javascript',
      'js'    => 'application/javascript',
      'jsi'   => 'application/javascript',
      'txt'   => 'text/plain',
      'html'  => 'text/html',
      'fhtml' => 'text/html',
      'popup' => 'text/html',
